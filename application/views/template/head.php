<head>
  ...
  <title>FASKES KIA | Dashboard</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url()."assets/template/back/"; ?>bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Toastr -->
  <link rel="stylesheet" href="<?php echo base_url()."assets/template/back/"; ?>plugins/toastr/build/toastr.min.css">
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="<?php echo base_url()."assets/template/back/"; ?>favicon.ico" />
