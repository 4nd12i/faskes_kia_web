<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2020 <a href="#">Fasilitas Kesehatan Ibu & Anak</a>.</strong> All rights
  reserved.
</footer>
...
<script src="<?php echo base_url()."assets/template/back/"; ?>bower_components/morris.js/morris.js"></script>
<!-- Sparkline -->
...
<!-- bootstrap time picker -->
<script src="<?php echo base_url()."assets/template/back/"; ?>plugins/toastr/build/toastr.min.js"></script>
<!-- CK Editor -->
<script src="<?php echo base_url()."assets/template/back/"; ?>bower_components/ckeditor/ckeditor.js"></script>
<!-- Openlayers Maps Script -->
...
<script type="text/javascript">
  var map = new ol.Map({
    ...
    view: new ol.View({
      center: ol.proj.fromLonLat([112.73, -7.40]),
      zoom: 8
    })
  });
</script>
