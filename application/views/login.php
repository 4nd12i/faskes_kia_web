...
<div class="login-box">
  <div class="login-logo">
    <!-- <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url()."assets/template/back/"; ?>dist/img/logo/PCS Rates 1.png" style="width: 350px;"/></a> -->
    <a href="<?php echo base_url(); ?>"><center><h2><b>FASKES</b> KIA</h2><h5>Fasilitas Kesehatan Ibu & Anak</h5></center></a>
  </div>
  <!-- /.login-logo -->
